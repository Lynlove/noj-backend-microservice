package com.lyn.nojbackendquestionservice.controller;
...
import com.lyn.nojbackendmodel.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userFeignClient.getLoginUser(request);
        ThrowUtils.throwIf(!question.getUserId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser),
